...
function QuickSummary({ isExpanded, onToggle }: { isExpanded: boolean; onToggle: () => void }) {
 ...
 <div className="text-xs text-dim">MAX_TURNS</div>
 </div>
 <div className="bg-surface rounded-lg p-3 text-center border border-edge">
 ...
 {/* 核心流程 */}
 <div>
 <h4 className="text-sm font-semibold text-dim mb-2">核心循环</h4>
...
export function InteractionLoop() {
 ...
 <h2 className="text-2xl font-bold font-mono text-heading">交互主循环</h2>
 <p className="text-body mt-2 font-mono">
 ...
 <h4 className="text-heading font-semibold font-mono mt-6">上下文收集</h4>
 <CodeBlock
...
// - 上下文窗口管理`}
 ...
 <div className="text-heading font-bold mt-4">packages/core/src/core/geminiChat.ts</div>
 <div className="pl-4 space-y-1 text-dim">
 ...
 <div>
 <h4 className="text-heading font-semibold font-mono mb-3">Stream 事件处理</h4>
 <MermaidDiagram chart={streamEventsChart} title="流事件处理流程" />

 <div className="mt-4">
 <h5 className="text-heading font-semibold font-mono mb-2">17 种事件类型 (GeminiEventType)</h5>
 ...
 <td className="py-2 px-3 font-mono text-heading">Content</td>
 ...
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">ToolCallResponse</td>
 <td className="py-2 px-3">工具执行完成</td>
 <td className="py-2 px-3">结果进入对话历史</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">ToolCallConfirmation</td>
 <td className="py-2 px-3">等待用户确认</td>
 <td className="py-2 px-3">暂停执行，显示确认 UI</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-dim">UserCancelled</td>
 ...
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">ChatCompressed</td>
 <td className="py-2 px-3">对话历史压缩</td>
 <td className="py-2 px-3">token 优化，保留上下文</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">Thought</td>
 ...
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">Finished</td>
 <td className="py-2 px-3">响应完成</td>
 <td className="py-2 px-3">触发工具调度</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">LoopDetected</td>
 <td className="py-2 px-3">检测到循环</td>
 <td className="py-2 px-3">中断并提示用户</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">Citation</td>
 <td className="py-2 px-3">引用来源</td>
 <td className="py-2 px-3">附加到响应</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-dim">Retry</td>
 ...
 <tr>
 <td className="py-2 px-3 font-mono text-heading">ModelInfo</td>
 ...
 <div>
 <h4 className="text-heading font-semibold font-mono mb-3">Continuation 机制（核心创新）</h4>
 ...
 <code className="text-heading">100 turns</code>
 </div>
 <div className="flex justify-between">
 <span className="text-body">循环检测</span>
 <code className="text-heading">模式匹配</code>
 </div>
 <div className="flex justify-between">
 <span className="text-body">prompt_id</span>
 <code className="text-heading">相同值关联</code>
 </div>
 </div>
 </HighlightBox>
 </div>
 ...
 <p className="text-dim">当历史消息超过上下文窗口时，自动移除最旧的消息</p>
 </div>
 <div>
 <h5 className="font-semibold text-heading mb-1">历史压缩</h5>
 <p className="text-dim">使用摘要替换过长的历史对话，保留关键信息</p>
 </div>
 <div>
 <h5 className="font-semibold text-heading mb-1">思考记录</h5>
 <p className="text-dim">Thought 事件不计入对话历史，节省 Token</p>
 </div>
 </div>
 </HighlightBox>

 <h4 className="text-heading font-semibold font-mono mt-6">IDE 上下文增量</h4>
 <CodeBlock
...
// - 50ms 去抖动，避免频繁更新`}
 ...
 <h4 className="text-heading font-semibold font-mono mt-6">降级策略</h4>
 <CodeBlock
 title="错误处理与重试逻辑"
 code={`// API 错误重试
...
function setupAbortHandler(signal: AbortSignal) {
 ...
 <h4 className="text-heading font-semibold font-mono mt-6">配置选项</h4>
 <div className="overflow-x-auto">
 <table className="w-full text-sm">
 <thead>
 <tr className="text-left text-dim border- border-edge">
 ...
 <tbody className="text-body">
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">maxTurns</td>
 <td className="py-2 px-3">100</td>
 <td className="py-2 px-3">最大循环轮次</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">contextWindowSize</td>
 <td className="py-2 px-3">模型默认</td>
 <td className="py-2 px-3">上下文窗口大小</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">ideContextMaxFiles</td>
 <td className="py-2 px-3">10</td>
 <td className="py-2 px-3">IDE 上下文最大文件数</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">ideContextMaxFileSize</td>
 <td className="py-2 px-3">16KB</td>
 <td className="py-2 px-3">单个文件最大大小</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">streamTimeout</td>
 <td className="py-2 px-3">60s</td>
 <td className="py-2 px-3">流式响应超时时间</td>
 </tr>
 <tr>
 <td className="py-2 px-3 font-mono text-heading">retryAttempts</td>
...
`}</pre>
 ...
 <tbody className="text-body">
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">isSubmittingQueryRef</td>
 <td className="py-2 px-3 text-dim">useGeminiStream</td>
 <td className="py-2 px-3">useRef&lt;boolean&gt;</td>
 <td className="py-2 px-3">防止并发提交</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">sendPromise</td>
 <td className="py-2 px-3 text-dim">geminiChat.ts</td>
 <td className="py-2 px-3">Promise&lt;void&gt;</td>
 <td className="py-2 px-3">串行化多个 API 调用</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">requestQueue</td>
 <td className="py-2 px-3 text-dim">coreToolScheduler</td>
 <td className="py-2 px-3">ToolCallRequest[]</td>
 <td className="py-2 px-3">缓冲工具调用</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">conversationHistory</td>
 <td className="py-2 px-3 text-dim">geminiChat.ts</td>
 <td className="py-2 px-3">Message[]</td>
 <td className="py-2 px-3">对话历史记录</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">turnCount</td>
 <td className="py-2 px-3 text-dim">client.ts</td>
 <td className="py-2 px-3">number</td>
 <td className="py-2 px-3">当前轮次计数</td>
 </tr>
 <tr className="border- border-edge/50">
 <td className="py-2 px-3 font-mono text-heading">currentPromptId</td>
 <td className="py-2 px-3 text-dim">useGeminiStream</td>
 <td className="py-2 px-3">string</td>
 <td className="py-2 px-3">关联同一用户输入的所有轮次</td>
 </tr>
 <tr>
 <td className="py-2 px-3 font-mono text-heading">lastIdeContext</td>
 <td className="py-2 px-3 text-dim">client.ts</td>
 ...
 <div className="text-dim mb-2">触发场景：</div>
 ...
 <div className="bg-base/50 rounded p-3">
 <div className="text-dim mb-2">处理策略（按优先级）：</div>
...
if (totalTokens > contextWindowSize * 0.9) {
 ...
 <div className="bg-base/50 rounded p-3">
 <div className="text-dim mb-2">恢复策略：</div>
 <ul className="text-body space-y-1 list-disc list-inside">
 ...
 <div className="space-y-3 text-sm">
 <div className="bg-base/50 rounded p-3">
 <div className="text-dim mb-2">超时设置：</div>
 <div className="grid grid-cols-3 gap-2">
 <div className="bg-base p-2 rounded text-center">
 <div className="text-heading font-bold">2 分钟</div>
 <div className="text-dim text-xs">Shell 命令默认</div>
 </div>
 <div className="bg-base p-2 rounded text-center">
 <div className="text-heading font-bold">10 分钟</div>
 ...
 <div className="bg-base/50 rounded p-3">
 <div className="text-dim mb-2">超时后果：</div>
 <ul className="text-body space-y-1 list-disc list-inside">
 ...
 <div className="space-y-3 text-sm">
 <div className="bg-base/50 rounded p-3">
 <div className="text-dim mb-2">检测阈值：</div>
 <ul className="text-body space-y-1 list-disc list-inside">
 ...
 <div className="space-y-3 text-sm">
 <div className="bg-base/50 rounded p-3">
 <div className="text-dim mb-2">潜在竞态：</div>
 <ul className="text-body space-y-1 list-disc list-inside">
 ...
 <div className="space-y-3 text-sm">
 <div className="bg-base/50 rounded p-3">
 <div className="text-dim mb-2">可能原因：</div>
 <ul className="text-body space-y-1 list-disc list-inside">
 ...
 <h5 className="text-heading font-semibold mb-3">参考性能基准</h5>
 <div className="overflow-x-auto">
 <table className="w-full text-sm">
 <thead>
 <tr className="text-left text-dim border- border-edge">
