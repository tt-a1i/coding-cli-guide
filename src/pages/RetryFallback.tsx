...
export function RetryFallback() {
 ...
 style return_result fill:${getThemeColor("--mermaid-success-fill", "#dcfce7")},color:${getThemeColor("--color-text", "#1c1917")}
 style throw_error fill:${getThemeColor("--mermaid-danger-fill", "#fee2e2")},color:${getThemeColor("--color-text", "#1c1917")}
 style success fill:${getThemeColor("--mermaid-warning-fill", "#fef3c7")},color:${getThemeColor("--color-text", "#1c1917")}
 style check_retry fill:${getThemeColor("--mermaid-warning-fill", "#fef3c7")},color:${getThemeColor("--color-text", "#1c1917")}
 style check_attempts fill:${getThemeColor("--mermaid-warning-fill", "#fef3c7")},color:${getThemeColor("--color-text", "#1c1917")}
 style fallback_check fill:${getThemeColor("--mermaid-warning-fill", "#fef3c7")},color:${getThemeColor("--color-text", "#1c1917")}
`;
 ...
 style check_fallback fill:${getThemeColor("--mermaid-warning-fill", "#fef3c7")},color:${getThemeColor("--color-text", "#1c1917")}
 style success fill:${getThemeColor("--mermaid-warning-fill", "#fef3c7")},color:${getThemeColor("--color-text", "#1c1917")}
`;
...
class CircuitBreaker {
 ...
 {/* 概述 */}
 <section>
 <h2 className="text-2xl font-bold text-heading mb-4">重试与回退机制</h2>
 ...
 <div className="text-sm text-body">次尝试</div>
 </div>
 </HighlightBox>
 ...
 <div className="text-center">
 <div className="text-4xl font-bold text-heading">5</div>
 <div className="text-sm text-body">秒</div>
 </div>
 </HighlightBox>
 ...
 <div className="text-center">
 <div className="text-lg font-bold text-heading">Flash</div>
 <div className="text-sm text-body">gemini-2.5-flash</div>
 </div>
 </HighlightBox>
 </div>
 </section>
 ...
 {/* 重试流程 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">重试机制流程</h3>
 <MermaidDiagram chart={retryFlowChart} title="重试机制流程" />
 </section>

 {/* 重试配置 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">重试配置与延迟计算</h3>
 <CodeBlock code={retryConfigCode} language="typescript" title="指数退避配置" />

 <div className="mt-4 bg-surface rounded-lg p-4">
 <h4 className="font-semibold text-heading mb-2">指数退避示意图</h4>
 <div className="relative h-32 mt-4">
 <div className="absolute bottom-0 left-0 w-full h-px bg-elevated"></div>
 <div className="absolute bottom-0 left-0 h-full w-px bg-elevated"></div>
 ...
 <div
 key={i}
 className="absolute bottom-0 bg-elevated/70 rounded-t"
 style={{
 left: `${15 + i * 18}%`,
 width: '12%',
 height: item.height,
 ...
 >
 <span className="absolute -top-5 left-1/2 -translate-x-1/2 text-xs text-heading">
 {item.delay}s
 </span>
 </div>
 ))}

 <span className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-xs text-body">
 尝试次数
 </span>
 </div>
 </div>
 ...
 {/* 可重试错误 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">可重试错误判断</h3>
 <CodeBlock code={retryableErrorsCode} language="typescript" title="错误分类" />

 <div className="mt-4 grid grid-cols-2 gap-4">
 <HighlightBox title="可重试错误" color="green">
 <ul className="text-sm space-y-1">
 <li><code className="text-heading">429</code> - 速率限制</li>
 <li><code className="text-heading">500</code> - 服务器内部错误</li>
 <li><code className="text-heading">502</code> - 网关错误</li>
 <li><code className="text-heading">503</code> - 服务不可用</li>
 <li><code className="text-heading">504</code> - 网关超时</li>
 <li><code className="text-heading">ECONNRESET</code> - 连接重置</li>
 <li><code className="text-heading">ETIMEDOUT</code> - 连接超时</li>
 </ul>
 </HighlightBox>

 <HighlightBox title="不可重试错误" color="red">
 <ul className="text-sm space-y-1">
 <li><code className="text-heading">401</code> - 未授权</li>
 <li><code className="text-heading">403</code> - 禁止访问</li>
 <li><code className="text-heading">404</code> - 资源不存在</li>
 <li><code className="text-heading">INVALID_API_KEY</code> - 密钥无效</li>
 <li><code className="text-heading">INVALID_REQUEST</code> - 请求格式错误</li>
 <li><code className="text-heading">CONTENT_FILTERED</code> - 内容被过滤</li>
 </ul>
 </HighlightBox>
 </div>
 </section>
 ...
 {/* 重试实现 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">重试执行器实现</h3>
 <CodeBlock code={retryImplementationCode} language="typescript" title="withRetry 函数" />
 </section>

 {/* 回退流程 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">模型回退机制</h3>
 ...
 {/* 回退处理器 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">回退处理器实现</h3>
 ...
 <div>
 <h5 className="font-semibold text-heading mb-1">MODEL_OVERLOADED</h5>
 <p className="text-body">主模型过载，切换到更稳定的模型</p>
 </div>
 <div>
 <h5 className="font-semibold text-heading mb-1">CONTEXT_LENGTH_EXCEEDED</h5>
 <p className="text-body">上下文超长，切换到更大窗口的模型</p>
 </div>
 <div>
 <h5 className="font-semibold text-heading mb-1">RATE_LIMIT_EXCEEDED</h5>
 <p className="text-body">速率限制，切换到配额更高的模型</p>
 </div>
 <div>
 <h5 className="font-semibold text-heading mb-1">TIMEOUT</h5>
 <p className="text-body">请求超时，切换到更快的模型</p>
 </div>
 </div>
 </HighlightBox>
 </section>
