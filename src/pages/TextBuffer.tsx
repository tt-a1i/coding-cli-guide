        ...
        <div className="px-6 pb-6 space-y-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div className="bg-[var(--bg-card)] rounded-lg p-3 text-center border border-[var(--border-subtle)]">
              ...
              <div className="text-xs text-[var(--text-muted)]">行核心代码</div>
            </div>
            <div className="bg-[var(--bg-card)] rounded-lg p-3 text-center border border-[var(--border-subtle)]">
              <div className="text-2xl font-bold text-[var(--terminal-green)]">Vim</div>
              <div className="text-xs text-[var(--text-muted)]">模式支持</div>
            </div>
            <div className="bg-[var(--bg-card)] rounded-lg p-3 text-center border border-[var(--border-subtle)]">
              <div className="text-2xl font-bold text-[var(--amber)]">Unicode</div>
              <div className="text-xs text-[var(--text-muted)]">完整支持</div>
            </div>
            <div className="bg-[var(--bg-card)] rounded-lg p-3 text-center border border-[var(--border-subtle)]">
              <div className="text-2xl font-bold text-[var(--purple)]">useReducer</div>
              <div className="text-xs text-[var(--text-muted)]">状态管理</div>
            </div>
          </div>
...
const openExternalEditor = useCallback((): void => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-[var(--text-primary)] mb-2">TextBuffer 文本缓冲区</h1>
      ...
      <Layer title="架构概览" icon="🏗️" defaultOpen={true}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-[var(--bg-card)] p-4 rounded-lg border border-[var(--cyber-blue)]/30">
            <div className="text-[var(--cyber-blue)] font-bold mb-2">🎯 设计目标</div>
          ...
          <div className="bg-[var(--bg-card)] p-4 rounded-lg border border-[var(--terminal-green)]/30">
            <div className="text-[var(--terminal-green)] font-bold mb-2">📦 核心模式</div>
            <ul className="text-sm text-[var(--text-secondary)] space-y-1">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[var(--border-subtle)]">
                <th className="text-left py-2 text-[var(--text-muted)]">字段</th>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[var(--border-subtle)]">
                ...
                <th className="text-left py-2 text-[var(--text-muted)]">用途</th>
                <th className="text-left py-2 text-[var(--text-muted)]">触发方式</th>
              </tr>
            </thead>
            <tbody className="text-[var(--text-secondary)]">
              <tr className="border-b border-[var(--border-subtle)]/30">
      ...
      <Layer title="视觉换行" icon="📐" defaultOpen={false}>
        ...
        <div className="mt-4 bg-[var(--bg-terminal)] p-4 rounded-lg">
          <h4 className="text-[var(--terminal-green)] font-bold mb-2">逻辑 vs 视觉坐标</h4>
