...
// ]`}
 ...
 <div className="bg-elevated border border-edge rounded-lg px-4 py-2 text-center w-full max-w-md">
 <strong>2. 检查忽略规则</strong>
 <div className="text-xs text-body">.gitignore / .geminiignore</div>
 </div>
 <div className="text-heading">↓</div>
...
async function handleAtCommand({
 ...
 <h4 className="text-heading font-bold mb-2">目录路径</h4>
 <p className="text-sm text-body mb-2">
...
@不存在的文件.ts # 将尝试 glob 搜索，找不到则跳过`}
 ...
 <div className="bg-elevated border border-edge rounded-lg p-4">
 <h4 className="text-heading font-bold mb-2">FileDiscoveryService</h4>
 <p className="text-sm text-body">
 用于检查文件是否应该被忽略，
 ...
 <div className="bg-base/50 rounded-lg p-4 ">
 <h4 className="text-heading font-bold mb-2">为什么目录会自动展开为 ** glob 模式？</h4>
 <div className="text-sm text-body space-y-2">
 ...
 <div className="bg-base/50 rounded-lg p-4 ">
 <h4 className="text-heading font-bold mb-2">为什么找不到文件时尝试 glob 搜索？</h4>
 <div className="text-sm text-body space-y-2">
