...
`;
 ...
 <td className="py-2 px-3 font-mono text-heading">lydell-node-pty / node-pty</td>
 <td className="py-2 px-3 font-mono text-heading">child_process</td>
 </tr>
 </tbody>
 </table>
 </div>
...
const result = await ShellExecutionService.execute(
 ...
 <td className="py-2 px-3 text-heading">lydell-node-pty</td>
 <td className="py-2 px-3 text-heading">node-pty</td>
 <td className="py-2 px-3 text-heading">node-pty</td>
 <td className="py-2 px-3 text-heading">取决于基础镜像</td>
 </tr>
 <tr className="border- border-edge">
