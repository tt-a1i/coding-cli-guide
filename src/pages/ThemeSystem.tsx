...
// 加载自定义主题
// gemini config set theme my-theme`;

 const cliCommandsCode = `# 主题管理命令

# 列出所有可用主题
gemini config themes
# 输出:
# Available Themes:
# ────────────────────────────────
# dark (current)
...
# 切换主题
gemini config set theme dracula

# 预览主题
gemini config preview-theme monokai

# 重置为默认主题
gemini config set theme dark

# 导入自定义主题
gemini config import-theme ./my-theme.json

# 导出当前主题
gemini config export-theme > current-theme.json`;
 ...
 <div style={{ color: theme.ui.prompt }}>{theme.ui.promptSymbol} gemini</div>
 <div>
 ...
 {/* 概述 */}
 <section>
 <h2 className="text-2xl font-bold text-heading mb-4">主题系统</h2>
 ...
 <div className="text-4xl font-bold text-heading">20+</div>
 <div className="text-sm text-body">流行主题</div>
 </div>
 </HighlightBox>
 ...
 <code className="text-xs text-heading">16/256/真彩色</code>
 </HighlightBox>
 </div>
 </section>
 ...
 {/* 主题预览 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">主题预览</h3>
 ...
 <code key={theme} className="text-body">{theme}</code>
 ))}
 </div>
 </div>
 </section>
 ...
 {/* 主题服务 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">主题服务</h3>
 <CodeBlock code={themeServiceCode} language="typescript" title="ThemeService" />
 </section>

 {/* 颜色工具 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">颜色工具</h3>
 ...
 <div>
 <h5 className="font-semibold text-heading">真彩色 (24-bit)</h5>
 <p className="text-body">1600 万色，现代终端支持</p>
 <code className="text-xs">COLORTERM=truecolor</code>
 </div>
 <div>
 <h5 className="font-semibold text-heading">256 色</h5>
 <p className="text-body">大多数终端支持</p>
 <code className="text-xs">TERM=xterm-256color</code>
 </div>
 <div>
 <h5 className="font-semibold text-heading">16 色</h5>
 <p className="text-body">基本终端支持</p>
 ...
 {/* 自定义主题 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">自定义主题</h3>
 <CodeBlock code={customThemeCode} language="json" title="自定义主题文件" />
 </section>

 {/* CLI 命令 */}
 <section>
 <h3 className="text-xl font-semibold text-heading mb-4">主题命令</h3>
...
└──────────────────────────────────────────────────────────────────┘`}
 ...
 <h4 className="text-heading font-semibold mb-2">终端兼容性</h4>
 <ul className="text-sm text-body space-y-1">
 <li>→ 检测终端颜色支持</li>
 <li>→ 提供降级方案</li>
