...
async createFileSnapshot(message: string): Promise<string> {
 ...
 <tr>
 <td className="py-2 px-3 font-mono text-heading">Apply Conflict</td>
...
`}
 ...
 <tbody>
 <tr className="border- border-edge">
 <td className="py-2 px-3 text-heading">工具执行前</td>
