      ...
      {isExpanded && (
        <div className="px-6 pb-6 space-y-4">
          <div className="bg-[var(--bg-terminal)]/50 rounded-lg p-4 border-l-4 border-[var(--purple)]">
            <h4 className="text-[var(--purple)] font-bold mb-2">🧪 实验性功能</h4>
          ...
          <div className="bg-[var(--bg-terminal)]/50 rounded-lg p-4 border-l-4 border-[var(--amber)]">
            <h4 className="text-[var(--amber)] font-bold mb-2">🔧 典型使用场景</h4>
          ...
          <div className="bg-[var(--bg-terminal)]/50 rounded-lg p-4 border-l-4 border-[var(--cyber-blue)]">
            <h4 className="text-[var(--cyber-blue)] font-bold mb-2">🏗️ 核心流程</h4>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mt-2">
              <div className="bg-[var(--bg-card)] p-3 rounded border border-[var(--purple)]/30 text-center">
                <div className="text-[var(--purple)] font-semibold text-sm">1. 启动</div>
                <div className="text-xs text-[var(--text-muted)] mt-1">启动浏览器实例</div>
              </div>
              <div className="bg-[var(--bg-card)] p-3 rounded border border-[var(--cyber-blue)]/30 text-center">
                <div className="text-[var(--cyber-blue)] font-semibold text-sm">2. 导航</div>
                <div className="text-xs text-[var(--text-muted)] mt-1">访问目标 URL</div>
              </div>
              <div className="bg-[var(--bg-card)] p-3 rounded border border-[var(--terminal-green)]/30 text-center">
                <div className="text-[var(--terminal-green)] font-semibold text-sm">3. 操作</div>
                <div className="text-xs text-[var(--text-muted)] mt-1">元素交互/截图</div>
              </div>
              <div className="bg-[var(--bg-card)] p-3 rounded border border-[var(--amber)]/30 text-center">
                <div className="text-[var(--amber)] font-semibold text-sm">4. 返回</div>
                <div className="text-xs text-[var(--text-muted)] mt-1">结果回传模型</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
            <div className="bg-[var(--bg-card)] p-3 rounded border border-[var(--border-subtle)]">
              <div className="text-xl font-bold text-[var(--purple)]">Puppeteer</div>
              <div className="text-xs text-[var(--text-muted)]">浏览器驱动</div>
            </div>
            <div className="bg-[var(--bg-card)] p-3 rounded border border-[var(--border-subtle)]">
              <div className="text-xl font-bold text-[var(--terminal-green)]">Headless</div>
              <div className="text-xs text-[var(--text-muted)]">默认模式</div>
            </div>
            <div className="bg-[var(--bg-card)] p-3 rounded border border-[var(--border-subtle)]">
              <div className="text-xl font-bold text-[var(--amber)]">Screenshot</div>
              <div className="text-xs text-[var(--text-muted)]">视觉反馈</div>
            </div>
            <div className="bg-[var(--bg-card)] p-3 rounded border border-[var(--border-subtle)]">
              <div className="text-xl font-bold text-[var(--cyber-blue)]">CDP</div>
              <div className="text-xs text-[var(--text-muted)]">Chrome DevTools</div>
            </div>
          </div>
...
class ProgressReporter {
  ...
  return (
    <div>
      ...
      <h2 className="text-2xl text-cyan-400 mb-5">Browser Agent（浏览器代理）</h2>
      ...
      <section id="overview" className="mb-8">
        <Layer title="概述" icon="🌐">
          <p className="text-gray-300 mb-4">
            ...
            赋予模型与 Web 页面直接交互的能力。它作为 <code className="text-cyan-300">web_browser</code> 工具注册到
      ...
      <section id="architecture" className="mb-8">
        <Layer title="架构设计" icon="🏗️">
          <p className="text-gray-300 mb-4">
            Browser Agent 采用分层架构：<code className="text-cyan-300">BrowserTool</code> 作为工具入口，
            <code className="text-cyan-300"> BrowserController</code> 管理浏览器生命周期，
            <code className="text-cyan-300"> PageNavigator</code> 和{' '}
            <code className="text-cyan-300">ElementSelector</code> 分别处理导航和元素操作，
            <code className="text-cyan-300"> ProgressReporter</code> 通过 MessageBus 报告操作进度。
          </p>
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[var(--bg-terminal)]/50 rounded-lg p-4">
              <h4 className="text-[var(--amber)] font-semibold mb-2">BrowserController</h4>
            ...
            <div className="bg-[var(--bg-terminal)]/50 rounded-lg p-4">
              <h4 className="text-[var(--terminal-green)] font-semibold mb-2">PageNavigator / ElementSelector</h4>
              <ul className="text-sm text-gray-300 space-y-1">
      ...
      <section id="workflow" className="mb-8">
        <Layer title="工作流程" icon="🔄">
          <p className="text-gray-300 mb-4">
            ...
            <code className="text-cyan-300">web_browser</code> 工具。BrowserController 采用懒启动模式，
            首次调用时启动浏览器实例，后续操作复用同一实例，直到显式关闭或会话结束。
          </p>

          <MermaidDiagram chart={workflowDiagram} title="Browser Agent 工作流程" />

          <div className="mt-4 bg-[var(--bg-terminal)]/50 rounded-lg p-4">
            <h4 className="text-[var(--text-primary)] font-semibold mb-2">关键流程说明</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-300">
              <div>
                <div className="text-[var(--amber)] mb-1">懒启动策略</div>
                <p>
              ...
              <div>
                <div className="text-[var(--amber)] mb-1">实例复用</div>
                <p>
      ...
      <section id="core-features" className="mb-8">
        <Layer title="核心功能详解" icon="⚡">
          <div className="space-y-6">
            <div>
              <h4 className="text-lg font-medium text-[var(--text-primary)] mb-3">1. BrowserController — 浏览器生命周期管理</h4>
              <CodeBlock
            ...
            <div>
              <h4 className="text-lg font-medium text-[var(--text-primary)] mb-3">2. PageNavigator — 页面导航与等待</h4>
              <CodeBlock
            ...
            <div>
              <h4 className="text-lg font-medium text-[var(--text-primary)] mb-3">3. ElementSelector — 元素选择与操作</h4>
              <CodeBlock
      ...
      <section id="progress-overlay" className="mb-8">
        <Layer title="进度报告与自动化覆盖层" icon="📊">
          <p className="text-gray-300 mb-4">
            Browser Agent 通过 <code className="text-cyan-300">ProgressReporter</code> 向 MessageBus 发布操作进度，
            同时在浏览器页面中注入 <code className="text-cyan-300">AutomationOverlay</code> 提供操作可视化，
            帮助开发者理解当前自动化步骤。
          </p>
          ...
          <div className="mt-4 bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
            <h4 className="text-purple-400 font-semibold mb-2">AutomationOverlay 特性</h4>
            <ul className="text-sm text-gray-300 space-y-1">
      ...
      <section id="api" className="mb-8">
        <Layer title="API 接口（web_browser 工具）" icon="🔧">
          <p className="text-gray-300 mb-4">
            Browser Agent 通过 <code className="text-cyan-300">web_browser</code> 工具暴露所有功能。
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-gray-300">
                <tr className="border-b border-gray-800">
                  <td className="py-2 px-2 text-cyan-400">navigate</td>
                ...
                <tr className="border-b border-gray-800">
                  <td className="py-2 px-2 text-cyan-400">click</td>
                ...
                <tr className="border-b border-gray-800">
                  <td className="py-2 px-2 text-cyan-400">get_text</td>
                ...
                <tr className="border-b border-gray-800">
                  <td className="py-2 px-2 text-cyan-400">get_elements</td>
                  <td className="py-2 px-2 text-xs">（无）</td>
                  <td className="py-2 px-2 text-xs">列出可交互元素</td>
                  <td className="py-2 px-2 text-xs">元素摘要数组</td>
                </tr>
                <tr className="border-b border-gray-800">
                  <td className="py-2 px-2 text-cyan-400">evaluate</td>
                ...
                <tr className="border-b border-gray-800">
                  <td className="py-2 px-2 text-cyan-400">wait</td>
                ...
                <tr>
                  <td className="py-2 px-2 text-cyan-400">close</td>
                  <td className="py-2 px-2 text-xs">（无）</td>
      ...
      <section id="tool-integration" className="mb-8">
        <Layer title="与工具系统的集成" icon="🧩">
          <p className="text-gray-300 mb-4">
            Browser Agent 作为标准工具注册到 <code className="text-cyan-300">ToolRegistry</code>，
            遵循与其他内置工具相同的生命周期管理。通过{' '}
            <code className="text-cyan-300">experimental.browserAgent</code> 配置项控制是否启用。
          </p>
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-[var(--bg-terminal)]/50 rounded-lg p-4">
              <h4 className="text-[var(--cyber-blue)] font-semibold mb-2">工具注册</h4>
              <p className="text-sm text-gray-300">
            ...
            <div className="bg-[var(--bg-terminal)]/50 rounded-lg p-4">
              <h4 className="text-[var(--terminal-green)] font-semibold mb-2">生命周期绑定</h4>
              <p className="text-sm text-gray-300">
                通过 <code>onDispose()</code> 回调确保会话结束时浏览器实例被正确清理。
              </p>
            </div>
            <div className="bg-[var(--bg-terminal)]/50 rounded-lg p-4">
              <h4 className="text-[var(--amber)] font-semibold mb-2">MessageBus 集成</h4>
              <p className="text-sm text-gray-300">
      ...
      <section id="limitations" className="mb-8">
        <Layer title="限制和注意事项" icon="⚠️">
          ...
          <div className="mt-4 bg-[var(--bg-terminal)]/50 rounded-lg p-4">
            <h4 className="text-[var(--text-primary)] font-semibold mb-2">已知限制</h4>
...
// → 截图显示登录成功后的仪表板页面`}
      ...
      {/* 设计决策 */}
      <section id="design-decisions" className="mb-8 bg-gradient-to-r from-blue-900/20 to-cyan-900/20 rounded-xl border border-blue-500/30 p-6">
        <h3 className="text-xl font-semibold text-blue-400 mb-4">设计决策</h3>

        <div className="space-y-4">
          <div className="bg-black/30 rounded-lg p-4">
            <h4 className="text-lg font-medium text-gray-200 mb-2">为什么使用单一 action 枚举而非独立工具？</h4>
            <p className="text-sm text-gray-300">
              <strong className="text-white">决策</strong>：所有浏览器操作通过一个{' '}
          ...
          <div className="bg-black/30 rounded-lg p-4">
            <h4 className="text-lg font-medium text-gray-200 mb-2">为什么选择 Puppeteer 而非 Playwright？</h4>
            <p className="text-sm text-gray-300">
              <strong className="text-white">决策</strong>：使用 Puppeteer 作为浏览器自动化驱动。
            </p>
            <ul className="text-sm text-gray-300 list-disc list-inside mt-2 space-y-1">
          ...
          <div className="bg-black/30 rounded-lg p-4">
            <h4 className="text-lg font-medium text-gray-200 mb-2">为什么默认 Headless？</h4>
            <p className="text-sm text-gray-300">
              <strong className="text-white">决策</strong>：默认以无头模式运行浏览器。
            </p>
            <ul className="text-sm text-gray-300 list-disc list-inside mt-2 space-y-1">
