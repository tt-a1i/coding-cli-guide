  ...
  return (
    <div className="my-4 rounded-xl border border-gray-700/50 overflow-hidden">
      ...
      <div className="p-4 bg-gray-800/50">
        ...
        <div className="mb-3">
          <h5 className="text-cyan-400 text-xs font-semibold mb-2">关键操作：</h5>
        ...
        <div>
          <h5 className="text-cyan-400 text-xs font-semibold mb-2">源码位置：</h5>
...
export function EndToEndWalkthrough() {
  ...
  return (
    <div>
      <h2 className="text-2xl text-cyan-400 mb-2">端到端走读</h2>
      ...
      <div className="mb-8 p-6 rounded-xl bg-gradient-to-r from-cyan-900/40 to-blue-900/30 border border-cyan-500/40">
        ...
        <div className="space-y-3 text-gray-300 text-sm">
          <p>
            <strong className="text-cyan-400">一句话主线：</strong>
...
data: [DONE]`}
      ...
      <Layer title="关键入口（建议打开的源码点）" icon="🔍">
        ...
        <div className="mt-4 p-4 bg-gray-800/50 rounded-lg border border-gray-700">
          <h5 className="text-cyan-400 font-semibold mb-2">建议你打开的核心文件</h5>
