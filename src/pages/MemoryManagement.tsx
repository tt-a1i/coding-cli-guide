...
export function MemoryManagement() {
 ...
 <strong>记忆系统</strong>
 <p className="text-xs text-body">GEMINI.md 持久化知识</p>
 </div>
 <div className="text-center">
 <div className="text-2xl mb-1">🗜️</div>
 <strong>聊天压缩</strong>
 <p className="text-xs text-body">Token 使用优化</p>
 </div>
 <div className="text-center">
 <div className="text-2xl mb-1">💾</div>
 <strong>会话持久化</strong>
 <p className="text-xs text-body">聊天记录保存</p>
 </div>
 </div>
 </HighlightBox>
 </Layer>
...
export function findCompressSplitPoint(
 ...
 <h4 className="text-heading font-semibold mb-3">分割边界条件</h4>
 ...
 <td className="py-2 px-3 text-heading">不压缩全部</td>
...
export function tokenLimit(model: string): number {
 ...
 <div className="mt-4 p-4 bg-surface rounded-lg">
 <h4 className="text-heading font-semibold mb-3">主要模型 Token 限制（上游 tokenLimit）</h4>
 <div className="overflow-x-auto">
 <table className="w-full text-sm">
 <thead>
 <tr className="text-left border- border-edge">
 ...
 <tbody className="text-body">
 <tr className="border- border-edge">
 <td className="py-2 px-3 text-heading">gemini-1.5-pro</td>
 ...
 <tr className="border- border-edge">
 <td className="py-2 px-3 text-heading">gemini-2.5-flash / gemini-2.5-pro / gemini-2.0-flash</td>
 ...
 <tr>
 <td className="py-2 px-3 text-body">默认</td>
 <td className="py-2 px-3">1,048,576</td>
 <td className="py-2 px-3">（上游未定义）</td>
...
- 优先保留具体的代码路径和决策原因`}
 ...
 <div className="mt-4 p-4 bg-surface rounded-lg">
 <h4 className="text-heading font-semibold mb-2">生成的摘要结构</h4>
 <CodeBlock
 code={`<state_snapshot>
## 已完成任务
...
uiTelemetryService.updateTokenStats(tokens);`}
 ...
 {/* 设计决策 1 */}
 <div className="bg-elevated/10 border border-edge rounded-lg p-4">
 <h4 className="text-heading font-bold mb-2">为什么使用 Token 预算而非消息数量限制?</h4>
 <p className="text-sm text-body">
 ...
 {/* 设计决策 2 */}
 <div className="bg-elevated border border-edge rounded-lg p-4">
 <h4 className="text-heading font-bold mb-2">为什么压缩而非删除旧消息?</h4>
 <p className="text-sm text-body">
 ...
 {/* 设计决策 5 */}
 <div className="bg-elevated/10 border border-edge rounded-lg p-4 md:col-span-2">
 <h4 className="text-heading font-bold mb-2">为什么支持多级存储?</h4>
 <p className="text-sm text-body">
