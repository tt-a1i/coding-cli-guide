  ...
  return (
    <div className="bg-[var(--bg-terminal)] rounded-lg p-4 border border-[var(--border-subtle)]">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-sm font-mono font-bold text-[var(--text-primary)]">数据流</span>
      </div>
  ...
  return (
    <div className="bg-[var(--bg-terminal)] rounded-lg p-4 border border-[var(--border-subtle)]">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-sm font-mono font-bold text-[var(--text-primary)]">FunctionResponse 结构</span>
      </div>
  ...
  return (
    <div className="bg-[var(--bg-terminal)] rounded-lg p-4 border border-[var(--border-subtle)]">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-sm font-mono font-bold text-[var(--text-primary)]">对话历史</span>
      </div>
      ...
      <div className="space-y-2 text-xs font-mono">
        ...
        <div className="p-2 bg-[var(--terminal-green)]/10 rounded border border-[var(--terminal-green-dim)]">
          ...
          <div className="text-[var(--text-muted)]">读取 package.json</div>
        </div>
        ...
        {phase === 'continuation_ready' && (
          <div className="text-center py-2">
            <span className="text-[var(--purple)] animate-bounce inline-block">↓</span>
            <div className="text-[var(--purple)] text-xs">发送 Continuation</div>
          </div>
        )}
      </div>
    </div>
    ...
    <div className="bg-[var(--bg-panel)] rounded-xl p-8 border border-[var(--border-subtle)] relative overflow-hidden">
      ...
      <div className="p-4 bg-[var(--bg-void)] rounded-lg border border-[var(--border-subtle)]">
        <div className="flex items-center gap-4 mb-2">
          ...
          <span className="text-[var(--text-secondary)] font-mono">
            步骤：<span className="text-[var(--terminal-green)] font-bold">{currentStep + 1}</span>/{buildSteps.length}
          </span>
          {isPlaying && (
            <span className="text-[var(--amber)] font-mono text-sm animate-pulse">● 构建中</span>
          )}
        </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="p-3 bg-[var(--bg-void)] rounded-lg border border-[var(--cyber-blue-dim)]">
          <div className="text-xs font-mono text-[var(--cyber-blue)] font-bold mb-1">ID 匹配</div>
        ...
        <div className="p-3 bg-[var(--bg-void)] rounded-lg border border-[var(--terminal-green-dim)]">
          <div className="text-xs font-mono text-[var(--terminal-green)] font-bold mb-1">user 角色</div>
          <div className="text-xs font-mono text-[var(--text-muted)]">
            工具响应作为 user 消息添加到历史
          </div>
        </div>
        <div className="p-3 bg-[var(--bg-void)] rounded-lg border border-[var(--amber-dim)]">
          <div className="text-xs font-mono text-[var(--amber)] font-bold mb-1">二进制处理</div>
          <div className="text-xs font-mono text-[var(--text-muted)]">
            图像等附加为额外 Part
          </div>
        </div>
