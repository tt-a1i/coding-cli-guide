    ...
    <div className="min-h-screen p-8" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <div className="max-w-6xl mx-auto mb-8">
        ...
        <div className="mt-4 bg-amber-500/10 border border-amber-500/30 rounded-lg p-3 text-sm text-amber-200">
          ...
          <code className="bg-black/30 px-1 rounded">@google/genai</code> 的{' '}
          <code className="bg-black/30 px-1 rounded">functionCall / functionResponse</code> parts，
          不存在 OpenAI 的 <code className="bg-black/30 px-1 rounded">tool_calls</code> chunk 解析流程。
        </div>
      </div>
