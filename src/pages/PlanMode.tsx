        ...
        <div className="px-6 pb-6 space-y-4">
          ...
          <div className="bg-[var(--bg-terminal)]/50 rounded-lg p-4 border-l-4 border-[var(--amber)]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-2">
              <div className="bg-[var(--bg-panel)] p-2 rounded text-center">
                <div className="text-xs text-[var(--terminal-green)]">只读分析</div>
                <div className="text-[10px] text-[var(--text-muted)]">安全探索代码库</div>
              </div>
              <div className="bg-[var(--bg-panel)] p-2 rounded text-center">
                <div className="text-xs text-[var(--cyber-blue)]">Research Agent</div>
                <div className="text-[10px] text-[var(--text-muted)]">依赖深度分析</div>
              </div>
              <div className="bg-[var(--bg-panel)] p-2 rounded text-center">
                <div className="text-xs text-[var(--amber)]">注释反馈</div>
                <div className="text-[10px] text-[var(--text-muted)]">迭代优化方案</div>
              </div>
              <div className="bg-[var(--bg-panel)] p-2 rounded text-center">
                <div className="text-xs text-[var(--purple)]">压缩保留</div>
                <div className="text-[10px] text-[var(--text-muted)]">长对话不丢失</div>
              </div>
            </div>
          </div>
...
graph TB
    ...
    style PlanMode fill:#1a1e26,stroke:#3ddc84,stroke-width:2px
    style ReadOnly fill:#1a1e26,stroke:#4ec9b0,stroke-width:1px
    style Execution fill:#1a1e26,stroke:#f5a623,stroke-width:1px
`} />
      </section>
      ...
      <section id="commands">
        ...
        <div className="space-y-4">
          <div className="bg-[var(--bg-panel)] rounded-lg p-4 border border-[var(--border-subtle)]">
            <h4 className="text-[var(--terminal-green)] font-bold font-mono text-sm mb-2">/plan create [description]</h4>
            <p className="text-[var(--text-secondary)] text-sm">
...
/plan create "添加单元测试覆盖所有 API 端点"`} />
          ...
          <div className="bg-[var(--bg-panel)] rounded-lg p-4 border border-[var(--border-subtle)]">
            <h4 className="text-[var(--terminal-green)] font-bold font-mono text-sm mb-2">/plan show [planId]</h4>
            <p className="text-[var(--text-secondary)] text-sm">
          ...
          <div className="bg-[var(--bg-panel)] rounded-lg p-4 border border-[var(--border-subtle)]">
            <h4 className="text-[var(--terminal-green)] font-bold font-mono text-sm mb-2">/plan execute [planId]</h4>
            <p className="text-[var(--text-secondary)] text-sm">
          ...
          <div className="bg-[var(--bg-panel)] rounded-lg p-4 border border-[var(--border-subtle)]">
            <h4 className="text-[var(--terminal-green)] font-bold font-mono text-sm mb-2">/plan copy [planId]</h4>
            <p className="text-[var(--text-secondary)] text-sm">
          ...
          <div className="bg-[var(--bg-panel)] rounded-lg p-4 border border-[var(--border-subtle)]">
            <h4 className="text-[var(--terminal-green)] font-bold font-mono text-sm mb-2">/plan list</h4>
            <p className="text-[var(--text-secondary)] text-sm">
              列出所有计划及其状态。
            </p>
          </div>
    ...
    context.protect(serialized, {
      ...
      <section id="design-decisions">
        ...
        <div className="space-y-4">
          <div className="bg-[var(--bg-panel)] rounded-lg p-5 border border-[var(--border-subtle)]">
            <h4 className="text-[var(--amber)] font-bold mb-2">为什么是只读环境？</h4>
            <p className="text-[var(--text-secondary)] text-sm">
          ...
          <div className="bg-[var(--bg-panel)] rounded-lg p-5 border border-[var(--border-subtle)]">
            <h4 className="text-[var(--amber)] font-bold mb-2">为什么集成 Research Subagent？</h4>
            <p className="text-[var(--text-secondary)] text-sm">
          ...
          <div className="bg-[var(--bg-panel)] rounded-lg p-5 border border-[var(--border-subtle)]">
            <h4 className="text-[var(--amber)] font-bold mb-2">注释系统的价值</h4>
            <p className="text-[var(--text-secondary)] text-sm">
      ...
      <section id="best-practices">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-3 p-3 bg-[var(--bg-panel)] rounded-lg border border-[var(--border-subtle)]">
            <span className="text-[var(--terminal-green)] mt-0.5">✓</span>
            <div>
              <div className="text-sm text-[var(--text-primary)] font-medium">大规模重构时优先使用 Plan Mode</div>
          ...
          <div className="flex items-start gap-3 p-3 bg-[var(--bg-panel)] rounded-lg border border-[var(--border-subtle)]">
            <span className="text-[var(--terminal-green)] mt-0.5">✓</span>
            <div>
              <div className="text-sm text-[var(--text-primary)] font-medium">充分利用注释进行迭代</div>
              <div className="text-xs text-[var(--text-secondary)] mt-1">
          ...
          <div className="flex items-start gap-3 p-3 bg-[var(--bg-panel)] rounded-lg border border-[var(--border-subtle)]">
            <span className="text-[var(--terminal-green)] mt-0.5">✓</span>
            <div>
              <div className="text-sm text-[var(--text-primary)] font-medium">复制计划创建变体方案</div>
              <div className="text-xs text-[var(--text-secondary)] mt-1">
          ...
          <div className="flex items-start gap-3 p-3 bg-[var(--bg-panel)] rounded-lg border border-[var(--border-subtle)]">
            ...
            <div>
              <div className="text-sm text-[var(--text-primary)] font-medium">避免在简单任务中使用 Plan Mode</div>
              <div className="text-xs text-[var(--text-secondary)] mt-1">
