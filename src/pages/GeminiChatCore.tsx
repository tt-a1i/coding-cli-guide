...
function Introduction({ isExpanded, onToggle }: { isExpanded: boolean; onToggle: () => void }) {
 ...
 <div className="text-xs text-dim mt-1">发送用户消息</div>
 </div>
 <div className="bg-surface p-3 rounded border border-edge/30 text-center">
 ...
 <div className="bg-surface p-3 rounded border border-edge/30 text-center">
 <div className="text-heading font-semibold text-sm">4. Continue?</div>
 <div className="text-xs text-dim mt-1">判断是否继续</div>
 </div>
 </div>
 </div>
 ...
 <div className="bg-surface p-3 rounded border border-edge">
 <div className="text-xl font-bold text-heading">16</div>
 <div className="text-xs text-dim">事件类型</div>
 </div>
 <div className="bg-surface p-3 rounded border border-edge">
 <div className="text-xl font-bold text-heading">∞</div>
 <div className="text-xs text-dim">Continuation</div>
 </div>
 </div>
...
export function GeminiChatCore() {
 ...
 <div className="bg-base/50 rounded-lg p-3 text-xs font-mono">
 <span className="text-dim">// 每次请求都发送完整历史</span><br/>
 <span className="text-heading">generateContent</span>({'{'}
 <span className="text-heading">history</span>: [...allPreviousMessages]{'}'})
 </div>
 </div>
 ...
 <ul className="text-sm text-dim space-y-1 list-disc pl-4">
 <li>读取文件后，决定是否需要读更多</li>
 <li>执行命令后，决定下一步操作</li>
 <li>发现问题后，尝试修复</li>
 </ul>
 <div className="mt-3 bg-elevated/10 rounded p-2 text-xs">
 ...
 <div>
 <div className="font-semibold text-heading mb-1">Comprehensive（完整历史）</div>
 ...
 <div>
 <div className="font-semibold text-heading mb-1">Curated（精选历史）</div>
 <p className="text-dim">
 ...
 向上提供简单的 <code className="text-heading">sendMessage()</code> 接口，
...
history: Content[] = [
 ...
 <div>
 <strong className="text-heading">用户中断 (Ctrl+C)</strong>
 <p className="text-sm text-body">AbortController 信号触发</p>
 </div>
 </div>
 </div>
 </Layer>
 ...
 <div className="bg-elevated border border-edge rounded-lg px-6 py-3 text-center w-full max-w-md">
 <strong>while (turns {'>'} 0)</strong>
 <div className="text-sm text-body mt-1">核心循环开始</div>
 </div>
 <div className="text-heading">↓</div>
...
*/`}
 ...
 <div>
 <h5 className="font-semibold text-heading mb-2">第三层：循环检测</h5>
 <p className="text-body">检测重复模式自动中断</p>
 </div>
 </div>
 </HighlightBox>
 </Layer>
...
flowchart TB
 ...
 <h5 className="text-heading font-semibold mb-2">模块职责说明</h5>
 <div className="grid grid-cols-2 gap-4 text-sm text-body">
 <div>
 <h6 className="text-heading font-semibold mb-1">上游模块</h6>
